...
Upload resources exported by Mydea into the matching directory: `<category>/<collection>/<language>/` for Pages, Sections, and Lists, or `themes/` for shared Themes. Keep the original JSON format; do not edit Registry, digest, pull request, or Featured metadata by hand. CI validates every pull request.
